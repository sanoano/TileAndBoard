...
public class UIMouseSlide : MonoBehaviour
{//For use in mousing over UI buttons to make them jut out slightly. If the object has a UIDialogueSlide, it does some additional calcs
